...
public abstract class BaseOceanBaseFailureRecoveryTest
        extends BaseJdbcFailureRecoveryTest
{
    private TestingOceanBaseServer oceanBaseServer;

    public BaseOceanBaseFailureRecoveryTest(RetryPolicy retryPolicy)
    {
        super(retryPolicy);
    }
    ...
    protected QueryRunner createQueryRunner(
            ...
            throws Exception
    {
        this.oceanBaseServer = new TestingOceanBaseServer();
        return OceanBaseQueryRunner.builder(closeAfterClass(oceanBaseServer))
    ...
    {
        oceanBaseServer.execute("ALTER TABLE %s ADD PRIMARY KEY (%s)".formatted(tableName, primaryKey));
    }
}
