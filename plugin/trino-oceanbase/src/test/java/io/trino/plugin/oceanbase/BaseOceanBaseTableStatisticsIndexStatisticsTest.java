...
public abstract class BaseOceanBaseTableStatisticsIndexStatisticsTest
        extends BaseTestOceanBaseTableStatisticsTest
{
    protected BaseOceanBaseTableStatisticsIndexStatisticsTest(String dockerImageName)
    {
