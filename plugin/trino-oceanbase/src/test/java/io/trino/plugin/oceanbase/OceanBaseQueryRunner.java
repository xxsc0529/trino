...
public final class OceanBaseQueryRunner
{
    private OceanBaseQueryRunner() {}

    private static final String TPCH_SCHEMA = "tpch";

    public static Builder builder(TestingOceanBaseServer server)
    {
        return new Builder()
    ...
    public static void main(String[] args)
            throws Exception
    {
        QueryRunner queryRunner = builder(new TestingOceanBaseServer())
                .addCoordinatorProperty("http-server.http.port", "8080")
                .setInitialTables(TpchTable.getTables())
                .build();

        Logger log = Logger.get(OceanBaseQueryRunner.class);
